...
class WidgetRectFill(Widget):
    def __init__(self, display: Display, x: int, y: int, width: int, height: int, r: int, g: int, b: int):
        self.log = logging.getLogger("WidgetRectFill")
